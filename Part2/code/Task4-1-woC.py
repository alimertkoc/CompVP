...
def plot_learning_curves(history):
    ...
    plt.tight_layout()
    plt.savefig('networks/41-woc-learning_curves.png')
    plt.show()
...
def visualize_curriculum():
    ...
    plt.grid()
    plt.legend()
    plt.savefig('networks/41-woc-curriculum_visualization.png')
    plt.show()
...
def main():
    ...
    # Save the model
    torch.save(model.state_dict(), 'networks/task4-1-woC.pth')
