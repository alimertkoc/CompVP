...
def plot_learning_curves(history):
    ...
    plt.tight_layout()
    plt.savefig('networks/43-wc-learning_curves.png')
    plt.show()
...
def visualize_curriculum():
    ...
    plt.grid()
    plt.legend()
    plt.savefig('networks/43-wc-curriculum_visualization.png')
    plt.show()
...
def main():
    ...
    # Save the model
    torch.save(model.state_dict(), 'networks/task4-3-wC.pth')
