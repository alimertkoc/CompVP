...
def get_transform(stage):
    if stage == 1:
        ...
        return transforms.Compose([
            ...
            VisualAcuityDataset(month_age=0),  # Limited color depth
            transforms.ToTensor(),
        ...
        return transforms.Compose([
            transforms.Resize((64, 64)),
            VisualAcuityDataset(month_age=6),
            transforms.ToTensor(),
            transforms.Normalize((0.5,), (0.5,))
        ])
...
def plot_learning_curves(history):
    ...
    plt.tight_layout()
    plt.savefig('networks/44-va-wc-learning_curves.png')
    plt.show()
...
def visualize_curriculum():
    ...
    plt.grid()
    plt.legend()
    plt.savefig('networks/44-va-wc-curriculum_visualization.png')
    plt.show()
...
def main():
    ...
    # Save the model
    torch.save(model.state_dict(), 'networks/task4-4VA-wC.pth')
